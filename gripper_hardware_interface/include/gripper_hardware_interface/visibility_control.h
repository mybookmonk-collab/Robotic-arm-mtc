...
#ifndef GRIPPER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define GRIPPER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // GRIPPER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
